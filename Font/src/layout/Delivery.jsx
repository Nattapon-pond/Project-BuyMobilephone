    ...
    <div className="navbar-container">
      ...
      {/* <div className="background-containerG relative flex flex-col justify-center h-screen" scroll>
        <div className="button-container-group">
          <br />
          <Link to="/header" className="btn btn-outline btn-info">
            หน้าหลัก
          </Link>
          <Link to="/product" className="btn btn-outline btn-success">
            สินค้าทั้งหมด
          </Link>
          <Link to="/details" className="btn btn-outline btn-warning">
            หน้ารายละเอียดสินค้า
          </Link>
          <Link to="/contact" className="btn btn-outline btn-error">
            ติดต่อเรา
          </Link>
        </div>
        <br />
